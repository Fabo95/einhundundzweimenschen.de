...
export default function Datenschutz () {
    ...
    return (
        <div className='law container'>
            ...
            <h3 className="h3--law">1. Datenschutz auf einen Blick</h3> 
                ...
                <h3 className="h3--law">Datenerfassung auf dieser Website</h3> 
                ...
                <p> Wie erfassen wir Ihre Daten? <br/><br/>
                ...
                <p> Wofür nutzen wir Ihre Daten?<br/><br/>
                    Ein Teil der Daten wird erhoben, um eine fehlerfreie Bereitstellung der Website zu gewährleisten. Andere
                    Daten können zur Analyse Ihres Nutzerverhaltens verwendet werden.
                </p>
                <p> Welche Rechte haben Sie bezüglich Ihrer Daten?<br/><br/>
                    Sie haben jederzeit das Recht, unentgeltlich Auskunft über Herkunft, Empfänger und Zweck Ihrer
                    gespeicherten personenbezogenen Daten zu erhalten. Sie haben außerdem ein Recht, die Berichtigung oder
                    Löschung dieser Daten zu verlangen. Wenn Sie eine Einwilligung zur Datenverarbeitung erteilt haben,
                    können Sie diese Einwilligung jederzeit für die Zukunft widerrufen. Außerdem haben Sie das Recht, unter
                    bestimmten Umständen die Einschränkung der Verarbeitung Ihrer personenbezogenen Daten zu verlangen.
                    <br/> <br/>Des Weiteren steht Ihnen ein Beschwerderecht bei der zuständigen Aufsichtsbehörde zu. <br/> <br/>
                    Hierzu sowie zu weiteren Fragen zum Thema Datenschutz können Sie sich jederzeit an uns wenden.
                </p>
                <h3 className="h3--law">2. Hosting</h3> 
                <p> Strato <br/> <br/>
                ...
                <h3 className="h3--law">3. Allgemeine Hinweise und Pflichtinformationen</h3> 
                <p> Datenschutz <br/> <br/>
                ...
                <p> Hinweis zur verantwortlichen Stelle <br/> <br/>
                    Die verantwortliche Stelle für die Datenverarbeitung auf dieser Website ist:<br/><br/>
                    Fabian Hinz<br/>
                    Fritz-Bauer-Str. 21<br/>
                    53123 Bonn<br/>
                    Telefon: 01726422583<br/>
                    E-Mail: f-hinz@outlook.de<br/><br/>
                    Verantwortliche Stelle ist die natürliche oder juristische Person, die allein oder gemeinsam mit anderen über
                    die Zwecke und Mittel der Verarbeitung von personenbezogenen Daten (z. B. Namen, E-Mail-Adressen o. Ä.)
                    entscheidet.
                </p>
                <p> Speicherdauer<br/> <br/>
                ...
                <p> Widerruf Ihrer Einwilligung zur Datenverarbeitung<br/> <br/>
                ...
                <p>Auskunft, Löschung und Berichtigung<br/> <br/>
                    Sie haben im Rahmen der geltenden gesetzlichen Bestimmungen jederzeit das Recht auf unentgeltliche
                    Auskunft über Ihre gespeicherten personenbezogenen Daten, deren Herkunft und Empfänger und den
                    Zweck der Datenverarbeitung und ggf. ein Recht auf Berichtigung oder Löschung dieser Daten. Hierzu sowie
                    zu weiteren Fragen zum Thema personenbezogene Daten können Sie sich jederzeit an uns wenden
                </p>
                <p className="">Recht auf Einschränkung der Verarbeitung<br/> <br/>
                    Sie haben das Recht, die Einschränkung der Verarbeitung Ihrer personenbezogenen Daten zu verlangen.
                    Hierzu können Sie sich jederzeit an uns wenden. Das Recht auf Einschränkung der Verarbeitung besteht in
                    folgenden Fällen:
                </p>
                    <ul className="">
                        <li className="">Wenn Sie die Richtigkeit Ihrer bei uns gespeicherten personenbezogenen Daten bestreiten, benötigen wir
                    ...
                    <h3 className="h3--law">4. Datenerfassung auf dieser Website</h3> 
                    <p> Anfrage per E-Mail, Telefon oder Telefax <br/> <br/>
                    ...
                    <h3 className="h3--law">5. Plugins und Tools</h3> 
                    <p> Google Web Fonts (lokales Hosting) <br/> <br/>
                        ...
                        Sanity <br/> <br/>
                        Diese Seite nutzt als Content Management System die Dienste von Sanity.io, wodurch eine Verbindung zu Servern von Sanity.io hergestellt wird.
                        Sanity.io hat seinen Sitz in Norwegen und somit innerhalb des Europäischen Wirtschaftsraumes, wodurch ein entsprechendes Datenschutzviau (nach DSGVO) gewährleistet wird.
                        Weitere Informationen zu Sanity.io finden Sie unter
